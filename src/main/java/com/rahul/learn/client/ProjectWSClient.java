...
import com.rahul.learn.domain.Project;
...
public class ProjectWSClient {
	...
	public void create() throws Exception {
		...
		HttpEntity requestEntity = new StringEntity(
				properties.getProperty("createProject"));
	...
	public static void main(String[] args) throws Exception {
		ProjectWSClient client = new ProjectWSClient();
		client.create();
		client.create();
		client.create();
	...
	private void updateJsonResponse() {
		...
		try {
			Project project = objectMapper.readValue(jsonResponse, Project.class);
			project.setDescription("Updating the asset description");
			jsonResponse = objectMapper.writeValueAsString(project);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
