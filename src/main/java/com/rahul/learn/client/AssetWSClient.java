...
import com.rahul.learn.domain.Asset;
...
public class AssetWSClient {
	...
	public void create() throws Exception {
		...
		HttpEntity requestEntity = new StringEntity(
				properties.getProperty("createAsset"));
	...
	public static void main(String[] args) throws Exception {
		AssetWSClient client = new AssetWSClient();
		client.create();
		client.create();
		client.create();
		client.fetch();
	...
	private void updateJsonResponse() {
		...
		try {
			Asset asset = objectMapper.readValue(jsonResponse, Asset.class);
			asset.setDescription("Updating the asset description");
			jsonResponse = objectMapper.writeValueAsString(asset);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
